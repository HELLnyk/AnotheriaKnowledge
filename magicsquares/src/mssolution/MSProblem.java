...
public class MSProblem implements Runnable {
     ...
     * @return
     *      <code>true</code>, if the sum of the elements of the diagonals is equal to the magic constant,
     *      and <br><code>false</code> - otherwise
     */
    ...
    /**
     * check if sum of the element of input <code>int[]</code> array is equals to magic constant
     *
     * @param array
     *      <code>int[]</code> array, which will be checked
     * @return
     *      <code>true</code>, if sum of element is equals to magic constant
     *      and <br><code>false</code> - otherwise
     */
